...
module.exports.handleEvent = async function({ api, event, args, Threads, Users }) {
  ...
  var rand = tl[Math.floor(Math.random() * tl.length)]
    ...
    if ((event.body.toLowerCase() == "bot kese ho") || (event.body.toLowerCase() == "bot how are you") || (event.body.toLowerCase() == "chumtiya bot") || (event.body.toLowerCase() == "chumtiye bot")) {
   ...
   if ((event.body.toLowerCase() == "اسلام وعلیکم ورحمتہ اللہ") || (event.body.toLowerCase() == "اسلام وعلیکم")) {
  ...
  if ((event.body.toLowerCase() == "bot admin") || (event.body.toLowerCase() == "bot ka admin kon he")) {
   ...
   if ((event.body.toLowerCase() == "asalamualikum") || (event.body.toLowerCase() == "Asslam o Alikum") || (event.body.toLowerCase() == "ram ram")) {
  ...
  if ((event.body.toLowerCase() == "love you") || (event.body.toLowerCase() == "i lobe you")) {
  ...
  if ((event.body.toLowerCase() == "ullo") || (event.body.toLowerCase() == "ali") || (event.body.toLowerCase() == "dil") || (event.body.toLowerCase() == "zuni") || (event.body.toLowerCase() == "suki")) {
