...
module.exports.run = async ({ api, event, args }) => {
    ...
    const z_1 = (hours < 10 ? '0' : '') + hours;
    const x_1 = (minutes < 10 ? '0' : '') + minutes;
    const y_1 = (seconds < 10 ? '0' : '') + seconds;
    ...
    var id = k ? k : Math.floor(Math.random() * 883) + 1;
    ...
    registerFont(__dirname + `/tad/phenomicon.ttf`, { family: "phenomicon" });
    ctx.textAlign = "start";
    ...
    registerFont(__dirname + `/tad/UTM-Avo.ttf`, { family: "UTM" });
    ctx.textAlign = "start";
    ctx.font = "70px UTM";
    ...
    registerFont(__dirname + `/tad/CaviarDreams.ttf`, { family: "time" });
    ctx.textAlign = "start";
    ctx.font = "45px time";
